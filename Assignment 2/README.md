...
Most STM32 microcontrollers use Successive Approximation Register or SAR ADCs. It is called so because its mechanism involves successively approximating input voltage. 