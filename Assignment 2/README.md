...
2. The SARs in STM sets the MSB to 1 which the internal DAC converts to an analog voltage level. It is given by  
$$V_DAC = \frac{V_REF(3.3 V)}{4095(as 12 bits so value can go from 0 -> 4095)} * Binary input.$$ 