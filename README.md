...
3. The CPU carries out TIM2_IRQHandler function which resets flag status to 0 and toggles LED whilst the counter is counting independently starting the cycle again.